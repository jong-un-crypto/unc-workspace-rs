// This example shows how to use the `unc_abi_client` Macro Based API.
// We are generating client code using the schema for the ABI and and `workspaces-rs` to call into the contract.
// More information about usage can be found here: <https://github.com/unc/unc-abi-client-rs/blob/main/README.md>
//
...
unc_workspaces::unc_abi_client::generate!(AbiClient for "res/adder.json");
