...
/// URL to the mainnet RPC node provided by unc.org.
pub const RPC_URL: &str = "https://rpc.mainnet.unc.org";

/// URL to the mainnet archival RPC node provided by unc.org.
pub const ARCHIVAL_URL: &str = "https://archival-rpc.mainnet.unc.org";
    ...
    async fn from_builder<'a>(build: NetworkBuilder<'a, Self>) -> Result<Self> {
        ...
        Ok(Self {
            ...
            info: Info {
                ...
                root_id: "unc".parse().unwrap(),
                keystore_path: PathBuf::from(".unc-credentials/mainnet/"),
