...
/// The `Worker` type allows us to interact with any UNC related networks, such
...
/// Connect to the [testnet](https://explorer.testnet.unc.org/) network, and grab
/// a [`Worker`] that can interact with it.
pub fn testnet<'a>() -> NetworkBuilder<'a, Testnet> {
    NetworkBuilder::new("testnet")
}

/// Connect to the [testnet archival](https://unc-nodes.io/intro/node-types#archival-node)
...
/// Connect to the [mainnet](https://explorer.unc.org/) network, and grab
/// a [`Worker`] that can interact with it.
pub fn mainnet<'a>() -> NetworkBuilder<'a, Mainnet> {
    NetworkBuilder::new("mainnet")
}

/// Connect to the [mainnet archival](https://unc-nodes.io/intro/node-types#archival-node)
/// network, and grab a [`Worker`] that can interact with it.
